...
#ifndef LLDB_UTILITY_MEMORYSPACE_H
#define LLDB_UTILITY_MEMORYSPACE_H
...
bool fromJSON(const llvm::json::Value &value, MemorySpaceInfo &data,
              llvm::json::Path path);

llvm::json::Value toJSON(const MemorySpaceInfo &data);

} // namespace lldb_private

#endif // LLDB_UTILITY_MEMORYSPACE_H
