...
AmdDbgApiDispatchInfoKindToString(amd_dbgapi_dispatch_info_t info_kind) {
  ...
  case AMD_DBGAPI_DISPATCH_INFO_QUEUE:
    return "AMD_DBGAPI_DISPATCH_INFO_QUEUE";

  case AMD_DBGAPI_DISPATCH_INFO_AGENT:
    return "AMD_DBGAPI_DISPATCH_INFO_AGENT";

  case AMD_DBGAPI_DISPATCH_INFO_PROCESS:
    return "AMD_DBGAPI_DISPATCH_INFO_PROCESS";

  case AMD_DBGAPI_DISPATCH_INFO_ARCHITECTURE:
    return "AMD_DBGAPI_DISPATCH_INFO_ARCHITECTURE";

  case AMD_DBGAPI_DISPATCH_INFO_OS_QUEUE_PACKET_ID:
    return "AMD_DBGAPI_DISPATCH_INFO_OS_QUEUE_PACKET_ID";

  case AMD_DBGAPI_DISPATCH_INFO_BARRIER:
    return "AMD_DBGAPI_DISPATCH_INFO_BARRIER";

  case AMD_DBGAPI_DISPATCH_INFO_ACQUIRE_FENCE:
    return "AMD_DBGAPI_DISPATCH_INFO_ACQUIRE_FENCE";

  case AMD_DBGAPI_DISPATCH_INFO_RELEASE_FENCE:
    return "AMD_DBGAPI_DISPATCH_INFO_RELEASE_FENCE";

  case AMD_DBGAPI_DISPATCH_INFO_GRID_DIMENSIONS:
    return "AMD_DBGAPI_DISPATCH_INFO_GRID_DIMENSIONS";

  case AMD_DBGAPI_DISPATCH_INFO_WORKGROUP_SIZES:
    return "AMD_DBGAPI_DISPATCH_INFO_WORKGROUP_SIZES";

  case AMD_DBGAPI_DISPATCH_INFO_GRID_SIZES:
    return "AMD_DBGAPI_DISPATCH_INFO_GRID_SIZES";

  case AMD_DBGAPI_DISPATCH_INFO_PRIVATE_SEGMENT_SIZE:
    return "AMD_DBGAPI_DISPATCH_INFO_PRIVATE_SEGMENT_SIZE";

  case AMD_DBGAPI_DISPATCH_INFO_GROUP_SEGMENT_SIZE:
    return "AMD_DBGAPI_DISPATCH_INFO_GROUP_SEGMENT_SIZE";

  case AMD_DBGAPI_DISPATCH_INFO_KERNEL_ARGUMENT_SEGMENT_ADDRESS:
    return "AMD_DBGAPI_DISPATCH_INFO_KERNEL_ARGUMENT_SEGMENT_ADDRESS";

  case AMD_DBGAPI_DISPATCH_INFO_KERNEL_DESCRIPTOR_ADDRESS:
    return "AMD_DBGAPI_DISPATCH_INFO_KERNEL_DESCRIPTOR_ADDRESS";

  case AMD_DBGAPI_DISPATCH_INFO_KERNEL_CODE_ENTRY_ADDRESS:
    return "AMD_DBGAPI_DISPATCH_INFO_KERNEL_CODE_ENTRY_ADDRESS";

  case AMD_DBGAPI_DISPATCH_INFO_KERNEL_COMPLETION_ADDRESS:
    return "AMD_DBGAPI_DISPATCH_INFO_KERNEL_COMPLETION_ADDRESS";
  }
